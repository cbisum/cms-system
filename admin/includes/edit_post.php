<?php
    ...
    if(isset($_POST['update_post'])){
        ...
        echo "<p class='alert alert-success' >post updated.<a href='../post.php?p_id=$post_id'>View Post </a> or <a href='posts.php'>Edit more post </a></p> ";
...
?>
    ...
    <form action="" method='post' enctype='multipart/form-data'>
        ...
        <div class="form-group">
            ...
            <img src="../images/<?php echo $post_img; ?>" alt="image" width='100px' height ='100px' /> <br ><br >
