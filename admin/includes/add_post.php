...
<?php
    if(isset($_POST['create_post'])){
        ...
        echo "<p class='alert alert-success' >Post Added Successfully.<a href='../post.php?p_id=$the_post_id'>View Post </a> Or <a href='posts.php?source=add_post'>Add More Post </a></p> ";
}
?>
